...
`].filter(ma).join(`
`)),o=df(o),o=hm(o,t),o=fm(o,t),a=df(a),a=hm(a,t),a=fm(a,t),o=dm(o),a=dm(a),t.isRawShaderMaterial!==!0&&(S=`#version 300 es
`,_=[d,"#define attribute in","#define varying out","#define texture2D texture"].join(`
`)+`
`+_,m=["#define varying in",t.glslVersion===np?"":"layout(location = 0) out highp vec4 pc_fragColor;",t.glslVersion===np?"":"#define gl_FragColor pc_fragColor","#define gl_FragDepthEXT gl_FragDepth","#define texture2D texture","#define textureCube texture","#define texture2DProj textureProj","#define texture2DLodEXT textureLod","#define texture2DProjLodEXT textureProjLod","#define textureCubeLodEXT textureLod","#define texture2DGradEXT textureGrad","#define texture2DProjGradEXT textureProjGrad","#define textureCubeGradEXT textureGrad"].join(`
`)+`
`+m);const y=S+_+o,x=S+m+a,A=lm(i,i.VERTEX_SHADER,y),E=lm(i,i.FRAGMENT_SHADER,x);i.attachShader(g,A),i.attachShader(g,E),t.index0AttributeName!==void 0?i.bindAttribLocation(g,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(g,0,"position"),i.linkProgram(g);function T(D){if(r.debug.checkShaderErrors){const L=i.getProgramInfoLog(g).trim(),F=i.getShaderInfoLog(A).trim(),k=i.getShaderInfoLog(E).trim();let Y=!0,V=!0;if(i.getProgramParameter(g,i.LINK_STATUS)===!1)if(Y=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(i,g,A,E);else{const W=um(i,A,"vertex"),z=um(i,E,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(g,i.VALIDATE_STATUS)+`
...
Program Info Log: `+L+`
`+W+`
`+z)}else L!==""?console.warn("THREE.WebGLProgram: Program Info Log:",L):(F===""||k==="")&&(V=!1);V&&(D.diagnostics={runnable:Y,programLog:L,vertexShader:{log:F,prefix:_},fragmentShader:{log:k,prefix:m}})}i.deleteShader(A),i.deleteShader(E),C=new vc(i,g),M=ME(i,g)}let C;this.getUniforms=function(){return C===void 0&&T(this),C};let M;this.getAttributes=function(){return M===void 0&&T(this),M};let v=t.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return v===!1&&(v=i.getProgramParameter(g,fE)),v},this.destroy=function(){n.releaseStatesOfProgram(this),i.deleteProgram(g),this.program=void 0},this.type=t.shaderType,this.name=t.shaderName,this.id=dE++,this.cacheKey=e,this.usedTimes=1,this.program=g,this.vertexShader=A,this.fragmentShader=E,this}let IE=0;class LE{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){const t=e.vertexShader,n=e.fragmentShader,i=this._getShaderStage(t),s=this._getShaderStage(n),o=this._getShaderCacheForMaterial(e);return o.has(i)===!1&&(o.add(i),i.usedTimes++),o.has(s)===!1&&(o.add(s),s.usedTimes++),this}remove(e){const t=this.materialCache.get(e);for(const n of t)n.usedTimes--,n.usedTimes===0&&this.shaderCache.delete(n.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const t=this.materialCache;let n=t.get(e);return n===void 0&&(n=new Set,t.set(e,n)),n}_getShaderStage(e){const t=this.shaderCache;let n=t.get(e);return n===void 0&&(n=new OE(e),t.set(e,n)),n}}class OE{constructor(e){this.id=IE++,this.code=e,this.usedTimes=0}}function UE(r,e,t,n,i,s,o){const a=new u_,l=new LE,c=new Set,u=[],h=i.logarithmicDepthBuffer,f=i.vertexTextures;let d=i.precision;const p={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distanceRGBA",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function g(M){return c.add(M),M===0?"uv":`uv${M}`}function _(M,v,D,L,F){const k=L.fog,Y=F.geometry,V=M.isMeshStandardMaterial?L.environment:null,W=(M.isMeshStandardMaterial?t:e).get(M.envMap||V),z=W&&W.mapping===nu?W.image.height:null,Q=p[M.type];M.precision!==null&&(d=i.getMaxPrecision(M.precision),d!==M.precision&&console.warn("THREE.WebGLProgram.getParameters:",M.precision,"not supported, using",d,"instead."));const N=Y.morphAttributes.position||Y.morphAttributes.normal||Y.morphAttributes.color,ce=N!==void 0?N.length:0;let Pe=0;Y.morphAttributes.position!==void 0&&(Pe=1),Y.morphAttributes.normal!==void 0&&(Pe=2),Y.morphAttributes.color!==void 0&&(Pe=3);let Re,q,re,_e;if(Q){const Ae=$i[Q];Re=Ae.vertexShader,q=Ae.fragmentShader}else Re=M.vertexShader,q=M.fragmentShader,l.update(M),re=l.getVertexShaderID(M),_e=l.getFragmentShaderID(M);const ue=r.getRenderTarget(),Ee=r.state.buffers.depth.getReversed(),Be=F.isInstancedMesh===!0,Oe=F.isBatchedMesh===!0,tt=!!M.map,Ze=!!M.matcap,ye=!!W,R=!!M.aoMap,le=!!M.lightMap,te=!!M.bumpMap,O=!!M.normalMap,J=!!M.displacementMap,Me=!!M.emissiveMap,ae=!!M.metalnessMap,fe=!!M.roughnessMap,We=M.anisotropy>0,P=M.clearcoat>0,b=M.dispersion>0,G=M.iridescence>0,Z=M.sheen>0,K=M.transmission>0,$=We&&!!M.anisotropyMap,we=P&&!!M.clearcoatMap,de=P&&!!M.clearcoatNormalMap,Ne=P&&!!M.clearcoatRoughnessMap,me=G&&!!M.iridescenceMap,ie=G&&!!M.iridescenceThicknessMap,Se=Z&&!!M.sheenColorMap,Ge=Z&&!!M.sheenRoughnessMap,Ve=!!M.specularMap,pe=!!M.specularColorMap,Ye=!!M.specularIntensityMap,I=K&&!!M.transmissionMap,ge=K&&!!M.thicknessMap,ne=!!M.gradientMap,Te=!!M.alphaMap,se=M.alphaTest>0,ee=!!M.alphaHash,De=!!M.extensions;let Xe=Vr;M.toneMapped&&(ue===null||ue.isXRRenderTarget===!0)&&(Xe=r.toneMapping);const gt={shaderID:Q,shaderType:M.type,shaderName:M.name,vertexShader:Re,fragmentShader:q,defines:M.defines,customVertexShaderID:re,customFragmentShaderID:_e,isRawShaderMaterial:M.isRawShaderMaterial===!0,glslVersion:M.glslVersion,precision:d,batching:Oe,batchingColor:Oe&&F._colorsTexture!==null,instancing:Be,instancingColor:Be&&F.instanceColor!==null,instancingMorph:Be&&F.morphTexture!==null,supportsVertexTextures:f,outputColorSpace:ue===null?r.outputColorSpace:ue.isXRRenderTarget===!0?ue.texture.colorSpace:Oo,alphaToCoverage:!!M.alphaToCoverage,map:tt,matcap:Ze,envMap:ye,envMapMode:ye&&W.mapping,envMapCubeUVHeight:z,aoMap:R,lightMap:le,bumpMap:te,normalMap:O,displacementMap:f&&J,emissiveMap:Me,normalMapObjectSpace:O&&M.normalMapType===ix,normalMapTangentSpace:O&&M.normalMapType===o_,metalnessMap:ae,roughnessMap:fe,anisotropy:We,anisotropyMap:$,clearcoat:P,clearcoatMap:we,clearcoatNormalMap:de,clearcoatRoughnessMap:Ne,dispersion:b,iridescence:G,iridescenceMap:me,iridescenceThicknessMap:ie,sheen:Z,sheenColorMap:Se,sheenRoughnessMap:Ge,specularMap:Ve,specularColorMap:pe,specularIntensityMap:Ye,transmission:K,transmissionMap:I,thicknessMap:ge,gradientMap:ne,opaque:M.transparent===!1&&M.blending===Mo&&M.alphaToCoverage===!1,alphaMap:Te,alphaTest:se,alphaHash:ee,combine:M.combine,mapUv:tt&&g(M.map.channel),aoMapUv:R&&g(M.aoMap.channel),lightMapUv:le&&g(M.lightMap.channel),bumpMapUv:te&&g(M.bumpMap.channel),normalMapUv:O&&g(M.normalMap.channel),displacementMapUv:J&&g(M.displacementMap.channel),emissiveMapUv:Me&&g(M.emissiveMap.channel),metalnessMapUv:ae&&g(M.metalnessMap.channel),roughnessMapUv:fe&&g(M.roughnessMap.channel),anisotropyMapUv:$&&g(M.anisotropyMap.channel),clearcoatMapUv:we&&g(M.clearcoatMap.channel),clearcoatNormalMapUv:de&&g(M.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:Ne&&g(M.clearcoatRoughnessMap.channel),iridescenceMapUv:me&&g(M.iridescenceMap.channel),iridescenceThicknessMapUv:ie&&g(M.iridescenceThicknessMap.channel),sheenColorMapUv:Se&&g(M.sheenColorMap.channel),sheenRoughnessMapUv:Ge&&g(M.sheenRoughnessMap.channel),specularMapUv:Ve&&g(M.specularMap.channel),specularColorMapUv:pe&&g(M.specularColorMap.channel),specularIntensityMapUv:Ye&&g(M.specularIntensityMap.channel),transmissionMapUv:I&&g(M.transmissionMap.channel),thicknessMapUv:ge&&g(M.thicknessMap.channel),alphaMapUv:Te&&g(M.alphaMap.channel),vertexTangents:!!Y.attributes.tangent&&(O||We),vertexColors:M.vertexColors,vertexAlphas:M.vertexColors===!0&&!!Y.attributes.color&&Y.attributes.color.itemSize===4,pointsUvs:F.isPoints===!0&&!!Y.attributes.uv&&(tt||Te),fog:!!k,useFog:M.fog===!0,fogExp2:!!k&&k.isFogExp2,flatShading:M.flatShading===!0&&M.wireframe===!1,sizeAttenuation:M.sizeAttenuation===!0,logarithmicDepthBuffer:h,reverseDepthBuffer:Ee,skinning:F.isSkinnedMesh===!0,morphTargets:Y.morphAttributes.position!==void 0,morphNormals:Y.morphAttributes.normal!==void 0,morphColors:Y.morphAttributes.color!==void 0,morphTargetsCount:ce,morphTextureStride:Pe,numDirLights:v.directional.length,numPointLights:v.point.length,numSpotLights:v.spot.length,numSpotLightMaps:v.spotLightMap.length,numRectAreaLights:v.rectArea.length,numHemiLights:v.hemi.length,numDirLightShadows:v.directionalShadowMap.length,numPointLightShadows:v.pointShadowMap.length,numSpotLightShadows:v.spotShadowMap.length,numSpotLightShadowsWithMaps:v.numSpotLightShadowsWithMaps,numLightProbes:v.numLightProbes,numClippingPlanes:o.numPlanes,numClipIntersection:o.numIntersection,dithering:M.dithering,shadowMapEnabled:r.shadowMap.enabled&&D.length>0,shadowMapType:r.shadowMap.type,toneMapping:Xe,decodeVideoTexture:tt&&M.map.isVideoTexture===!0&&dt.getTransfer(M.map.colorSpace)===wt,decodeVideoTextureEmissive:Me&&M.emissiveMap.isVideoTexture===!0&&dt.getTransfer(M.emissiveMap.colorSpace)===wt,premultipliedAlpha:M.premultipliedAlpha,doubleSided:M.side===Fi,flipSided:M.side===Vn,useDepthPacking:M.depthPacking>=0,depthPacking:M.depthPacking||0,index0AttributeName:M.index0AttributeName,extensionClipCullDistance:De&&M.extensions.clipCullDistance===!0&&n.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(De&&M.extensions.multiDraw===!0||Oe)&&n.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:n.has("KHR_parallel_shader_compile"),customProgramCacheKey:M.customProgramCacheKey()};return gt.vertexUv1s=c.has(1),gt.vertexUv2s=c.has(2),gt.vertexUv3s=c.has(3),c.clear(),gt}function m(M){const v=[];if(M.shaderID?v.push(M.shaderID):(v.push(M.customVertexShaderID),v.push(M.customFragmentShaderID)),M.defines!==void 0)for(const D in M.defines)v.push(D),v.push(M.defines[D]);return M.isRawShaderMaterial===!1&&(S(v,M),y(v,M),v.push(r.outputColorSpace)),v.push(M.customProgramCacheKey),v.join()}function S(M,v){M.push(v.precision),M.push(v.outputColorSpace),M.push(v.envMapMode),M.push(v.envMapCubeUVHeight),M.push(v.mapUv),M.push(v.alphaMapUv),M.push(v.lightMapUv),M.push(v.aoMapUv),M.push(v.bumpMapUv),M.push(v.normalMapUv),M.push(v.displacementMapUv),M.push(v.emissiveMapUv),M.push(v.metalnessMapUv),M.push(v.roughnessMapUv),M.push(v.anisotropyMapUv),M.push(v.clearcoatMapUv),M.push(v.clearcoatNormalMapUv),M.push(v.clearcoatRoughnessMapUv),M.push(v.iridescenceMapUv),M.push(v.iridescenceThicknessMapUv),M.push(v.sheenColorMapUv),M.push(v.sheenRoughnessMapUv),M.push(v.specularMapUv),M.push(v.specularColorMapUv),M.push(v.specularIntensityMapUv),M.push(v.transmissionMapUv),M.push(v.thicknessMapUv),M.push(v.combine),M.push(v.fogExp2),M.push(v.sizeAttenuation),M.push(v.morphTargetsCount),M.push(v.morphAttributeCount),M.push(v.numDirLights),M.push(v.numPointLights),M.push(v.numSpotLights),M.push(v.numSpotLightMaps),M.push(v.numHemiLights),M.push(v.numRectAreaLights),M.push(v.numDirLightShadows),M.push(v.numPointLightShadows),M.push(v.numSpotLightShadows),M.push(v.numSpotLightShadowsWithMaps),M.push(v.numLightProbes),M.push(v.shadowMapType),M.push(v.toneMapping),M.push(v.numClippingPlanes),M.push(v.numClipIntersection),M.push(v.depthPacking)}function y(M,v){a.disableAll(),v.supportsVertexTextures&&a.enable(0),v.instancing&&a.enable(1),v.instancingColor&&a.enable(2),v.instancingMorph&&a.enable(3),v.matcap&&a.enable(4),v.envMap&&a.enable(5),v.normalMapObjectSpace&&a.enable(6),v.normalMapTangentSpace&&a.enable(7),v.clearcoat&&a.enable(8),v.iridescence&&a.enable(9),v.alphaTest&&a.enable(10),v.vertexColors&&a.enable(11),v.vertexAlphas&&a.enable(12),v.vertexUv1s&&a.enable(13),v.vertexUv2s&&a.enable(14),v.vertexUv3s&&a.enable(15),v.vertexTangents&&a.enable(16),v.anisotropy&&a.enable(17),v.alphaHash&&a.enable(18),v.batching&&a.enable(19),v.dispersion&&a.enable(20),v.batchingColor&&a.enable(21),v.gradientMap&&a.enable(22),M.push(a.mask),a.disableAll(),v.fog&&a.enable(0),v.useFog&&a.enable(1),v.flatShading&&a.enable(2),v.logarithmicDepthBuffer&&a.enable(3),v.reverseDepthBuffer&&a.enable(4),v.skinning&&a.enable(5),v.morphTargets&&a.enable(6),v.morphNormals&&a.enable(7),v.morphColors&&a.enable(8),v.premultipliedAlpha&&a.enable(9),v.shadowMapEnabled&&a.enable(10),v.doubleSided&&a.enable(11),v.flipSided&&a.enable(12),v.useDepthPacking&&a.enable(13),v.dithering&&a.enable(14),v.transmission&&a.enable(15),v.sheen&&a.enable(16),v.opaque&&a.enable(17),v.pointsUvs&&a.enable(18),v.decodeVideoTexture&&a.enable(19),v.decodeVideoTextureEmissive&&a.enable(20),v.alphaToCoverage&&a.enable(21),M.push(a.mask)}function x(M){const v=p[M.type];let D;if(v){const L=$i[v];D=Zx.clone(L.uniforms)}else D=M.uniforms;return D}function A(M,v){let D;for(let L=0,F=u.length;L<F;L++){const k=u[L];if(k.cacheKey===v){D=k,++D.usedTimes;break}}return D===void 0&&(D=new NE(r,v,M,s),u.push(D)),D}function E(M){if(--M.usedTimes===0){const v=u.indexOf(M);u[v]=u[u.length-1],u.pop(),M.destroy()}}function T(M){l.remove(M)}function C(){l.dispose()}return{getParameters:_,getProgramCacheKey:m,getUniforms:x,acquireProgram:A,releaseProgram:E,releaseShaderCache:T,programs:u,dispose:C}}function FE(){let r=new WeakMap;function e(o){return r.has(o)}function t(o){let a=r.get(o);return a===void 0&&(a={},r.set(o,a)),a}function n(o){r.delete(o)}function i(o,a,l){r.get(o)[a]=l}function s(){r=new WeakMap}return{has:e,get:t,remove:n,update:i,dispose:s}}function zE(r,e){return r.groupOrder!==e.groupOrder?r.groupOrder-e.groupOrder:r.renderOrder!==e.renderOrder?r.renderOrder-e.renderOrder:r.material.id!==e.material.id?r.material.id-e.material.id:r.z!==e.z?r.z-e.z:r.id-e.id}function mm(r,e){return r.groupOrder!==e.groupOrder?r.groupOrder-e.groupOrder:r.renderOrder!==e.renderOrder?r.renderOrder-e.renderOrder:r.z!==e.z?e.z-r.z:r.id-e.id}function gm(){const r=[];let e=0;const t=[],n=[],i=[];function s(){e=0,t.length=0,n.length=0,i.length=0}function o(h,f,d,p,g,_){let m=r[e];return m===void 0?(m={id:h.id,object:h,geometry:f,material:d,groupOrder:p,renderOrder:h.renderOrder,z:g,group:_},r[e]=m):(m.id=h.id,m.object=h,m.geometry=f,m.material=d,m.groupOrder=p,m.renderOrder=h.renderOrder,m.z=g,m.group=_),e++,m}function a(h,f,d,p,g,_){const m=o(h,f,d,p,g,_);d.transmission>0?n.push(m):d.transparent===!0?i.push(m):t.push(m)}function l(h,f,d,p,g,_){const m=o(h,f,d,p,g,_);d.transmission>0?n.unshift(m):d.transparent===!0?i.unshift(m):t.unshift(m)}function c(h,f){t.length>1&&t.sort(h||zE),n.length>1&&n.sort(f||mm),i.length>1&&i.sort(f||mm)}function u(){for(let h=e,f=r.length;h<f;h++){const d=r[h];if(d.id===null)break;d.id=null,d.object=null,d.geometry=null,d.material=null,d.group=null}}return{opaque:t,transmissive:n,transparent:i,init:s,push:a,unshift:l,finish:u,sort:c}}function BE(){let r=new WeakMap;function e(n,i){const s=r.get(n);let o;return s===void 0?(o=new gm,r.set(n,[o])):i>=s.length?(o=new gm,s.push(o)):o=s[i],o}function t(){r=new WeakMap}return{get:e,dispose:t}}function kE(){const r={};return{get:function(e){if(r[e.id]!==void 0)return r[e.id];let t;switch(e.type){case"DirectionalLight":t={direction:new U,color:new et};break;case"SpotLight":t={position:new U,direction:new U,color:new et,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":t={position:new U,color:new et,distance:0,decay:0};break;case"HemisphereLight":t={direction:new U,skyColor:new et,groundColor:new et};break;case"RectAreaLight":t={color:new et,position:new U,halfWidth:new U,halfHeight:new U};break}return r[e.id]=t,t}}}function VE(){const r={};return{get:function(e){if(r[e.id]!==void 0)return r[e.id];let t;switch(e.type){case"DirectionalLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new he};break;case"SpotLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new he};break;case"PointLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new he,shadowCameraNear:1,shadowCameraFar:1e3};break}return r[e.id]=t,t}}}let HE=0;function GE(r,e){return(e.castShadow?2:0)-(r.castShadow?2:0)+(e.map?1:0)-(r.map?1:0)}function WE(r){const e=new kE,t=VE(),n={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let c=0;c<9;c++)n.probe.push(new U);const i=new U,s=new at,o=new at;function a(c){let u=0,h=0,f=0;for(let M=0;M<9;M++)n.probe[M].set(0,0,0);let d=0,p=0,g=0,_=0,m=0,S=0,y=0,x=0,A=0,E=0,T=0;c.sort(GE);for(let M=0,v=c.length;M<v;M++){const D=c[M],L=D.color,F=D.intensity,k=D.distance,Y=D.shadow&&D.shadow.map?D.shadow.map.texture:null;if(D.isAmbientLight)u+=L.r*F,h+=L.g*F,f+=L.b*F;else if(D.isLightProbe){for(let V=0;V<9;V++)n.probe[V].addScaledVector(D.sh.coefficients[V],F);T++}else if(D.isDirectionalLight){const V=e.get(D);if(V.color.copy(D.color).multiplyScalar(D.intensity),D.castShadow){const W=D.shadow,z=t.get(D);z.shadowIntensity=W.intensity,z.shadowBias=W.bias,z.shadowNormalBias=W.normalBias,z.shadowRadius=W.radius,z.shadowMapSize=W.mapSize,n.directionalShadow[d]=z,n.directionalShadowMap[d]=Y,n.directionalShadowMatrix[d]=D.shadow.matrix,S++}n.directional[d]=V,d++}else if(D.isSpotLight){const V=e.get(D);V.position.setFromMatrixPosition(D.matrixWorld),V.color.copy(L).multiplyScalar(F),V.distance=k,V.coneCos=Math.cos(D.angle),V.penumbraCos=Math.cos(D.angle*(1-D.penumbra)),V.decay=D.decay,n.spot[g]=V;const W=D.shadow;if(D.map&&(n.spotLightMap[A]=D.map,A++,W.updateMatrices(D),D.castShadow&&E++),n.spotLightMatrix[g]=W.matrix,D.castShadow){const z=t.get(D);z.shadowIntensity=W.intensity,z.shadowBias=W.bias,z.shadowNormalBias=W.normalBias,z.shadowRadius=W.radius,z.shadowMapSize=W.mapSize,n.spotShadow[g]=z,n.spotShadowMap[g]=Y,x++}g++}else if(D.isRectAreaLight){const V=e.get(D);V.color.copy(L).multiplyScalar(F),V.halfWidth.set(D.width*.5,0,0),V.halfHeight.set(0,D.height*.5,0),n.rectArea[_]=V,_++}else if(D.isPointLight){const V=e.get(D);if(V.color.copy(D.color).multiplyScalar(D.intensity),V.distance=D.distance,V.decay=D.decay,D.castShadow){const W=D.shadow,z=t.get(D);z.shadowIntensity=W.intensity,z.shadowBias=W.bias,z.shadowNormalBias=W.normalBias,z.shadowRadius=W.radius,z.shadowMapSize=W.mapSize,z.shadowCameraNear=W.camera.near,z.shadowCameraFar=W.camera.far,n.pointShadow[p]=z,n.pointShadowMap[p]=Y,n.pointShadowMatrix[p]=D.shadow.matrix,y++}n.point[p]=V,p++}else if(D.isHemisphereLight){const V=e.get(D);V.skyColor.copy(D.color).multiplyScalar(F),V.groundColor.copy(D.groundColor).multiplyScalar(F),n.hemi[m]=V,m++}}_>0&&(r.has("OES_texture_float_linear")===!0?(n.rectAreaLTC1=be.LTC_FLOAT_1,n.rectAreaLTC2=be.LTC_FLOAT_2):(n.rectAreaLTC1=be.LTC_HALF_1,n.rectAreaLTC2=be.LTC_HALF_2)),n.ambient[0]=u,n.ambient[1]=h,n.ambient[2]=f;const C=n.hash;(C.directionalLength!==d||C.pointLength!==p||C.spotLength!==g||C.rectAreaLength!==_||C.hemiLength!==m||C.numDirectionalShadows!==S||C.numPointShadows!==y||C.numSpotShadows!==x||C.numSpotMaps!==A||C.numLightProbes!==T)&&(n.directional.length=d,n.spot.length=g,n.rectArea.length=_,n.point.length=p,n.hemi.length=m,n.directionalShadow.length=S,n.directionalShadowMap.length=S,n.pointShadow.length=y,n.pointShadowMap.length=y,n.spotShadow.length=x,n.spotShadowMap.length=x,n.directionalShadowMatrix.length=S,n.pointShadowMatrix.length=y,n.spotLightMatrix.length=x+A-E,n.spotLightMap.length=A,n.numSpotLightShadowsWithMaps=E,n.numLightProbes=T,C.directionalLength=d,C.pointLength=p,C.spotLength=g,C.rectAreaLength=_,C.hemiLength=m,C.numDirectionalShadows=S,C.numPointShadows=y,C.numSpotShadows=x,C.numSpotMaps=A,C.numLightProbes=T,n.version=HE++)}function l(c,u){let h=0,f=0,d=0,p=0,g=0;const _=u.matrixWorldInverse;for(let m=0,S=c.length;m<S;m++){const y=c[m];if(y.isDirectionalLight){const x=n.directional[h];x.direction.setFromMatrixPosition(y.matrixWorld),i.setFromMatrixPosition(y.target.matrixWorld),x.direction.sub(i),x.direction.transformDirection(_),h++}else if(y.isSpotLight){const x=n.spot[d];x.position.setFromMatrixPosition(y.matrixWorld),x.position.applyMatrix4(_),x.direction.setFromMatrixPosition(y.matrixWorld),i.setFromMatrixPosition(y.target.matrixWorld),x.direction.sub(i),x.direction.transformDirection(_),d++}else if(y.isRectAreaLight){const x=n.rectArea[p];x.position.setFromMatrixPosition(y.matrixWorld),x.position.applyMatrix4(_),o.identity(),s.copy(y.matrixWorld),s.premultiply(_),o.extractRotation(s),x.halfWidth.set(y.width*.5,0,0),x.halfHeight.set(0,y.height*.5,0),x.halfWidth.applyMatrix4(o),x.halfHeight.applyMatrix4(o),p++}else if(y.isPointLight){const x=n.point[f];x.position.setFromMatrixPosition(y.matrixWorld),x.position.applyMatrix4(_),f++}else if(y.isHemisphereLight){const x=n.hemi[g];x.direction.setFromMatrixPosition(y.matrixWorld),x.direction.transformDirection(_),g++}}}return{setup:a,setupView:l,state:n}}function _m(r){const e=new WE(r),t=[],n=[];function i(u){c.camera=u,t.length=0,n.length=0}function s(u){t.push(u)}function o(u){n.push(u)}function a(){e.setup(t)}function l(u){e.setupView(t,u)}const c={lightsArray:t,shadowsArray:n,camera:null,lights:e,transmissionRenderTarget:{}};return{init:i,state:c,setupLights:a,setupLightsView:l,pushLight:s,pushShadow:o}}function XE(r){let e=new WeakMap;function t(i,s=0){const o=e.get(i);let a;return o===void 0?(a=new _m(r),e.set(i,[a])):s>=o.length?(a=new _m(r),o.push(a)):a=o[s],a}function n(){e=new WeakMap}return{get:t,dispose:n}}const YE=`void main() {
	gl_Position = vec4( position, 1.0 );
...
void main() {
    ...
    `,transparent:!0,depthWrite:!1}),l=new bn(new Ls(e,t),a);return l.rotation.x=-Math.PI/2,l.position.y=0,l.renderOrder=1,r.add(l),{mapMaterial:a,basemapMaterial:s}}const Mt=new URLSearchParams(location.search),ng=Mt.get("flatten")==="0"?0:mt.degToRad(-1.7),gA=Mt.get("regrade")!=="0",uo={CAP:1,FLOOR:.1,FLOOR_LOW:.05,DWELL_KEEP:.4,SAMPLES:2048,PASSES:3},pu=Mt.get("finale")==="1",Gd=Mt.get("chase")!=="0",ms={VMAX:parseFloat(Mt.get("chasev"))||.06,AMAX:.25,MAX_LAG:.25},Wd=Mt.get("paging")!=="0",_A=Wd&&Mt.get("snap")!=="0",Ri=matchMedia("(prefers-reduced-motion: reduce)").matches||Mt.get("reducedMotion")==="1",Va=Mt.get("buildings"),er=["legacy","tiles","off"].includes(Va)?Va:"tiles";Va&&Va!==er&&console.warn(`Unknown buildings mode "${Va}"; using tiles.`);const ig=1,vA=Mt.get("footprintlod")!=="0",BC=Mt.get("footprintmask")==="rgba"?"rgba":"r8",yi=Mt.get("idlesleep")!=="0",rg=Mt.get("buildingstream"),sg=["all","distance","objectdistance"].includes(rg)?rg:"objectdistance";function xA(){const r=/Android|iPhone|iPad|Mobile/i.test(navigator.userAgent),e=navigator.deviceMemory??8,t=navigator.hardwareConcurrency??8,n=!r&&e>=6&&t>=6,i=Mt.get("tier"),s=["high","low"].includes(i)?i:n?"high":"low",o=Mt.get("quality"),a=["1to10","1to1"].includes(o)?o:s==="low"?"1to10":"1to1";return{unit:a,strong:n,mobile:r,tier:s,low:s==="low",maxFps:(()=>{const l=parseFloat(Mt.get("fpscap"));return Number.isFinite(l)?l:60})(),idleFps:(()=>{const l=parseFloat(Mt.get("idlefps"));return Number.isFinite(l)?l:30})(),pixelRatio:(()=>{const l=parseFloat(Mt.get("dpr"));return Number.isFinite(l)?mt.clamp(l,.5,3):s==="high"?Math.min(devicePixelRatio,1.65):Math.min(devicePixelRatio,1.25)})(),pointSize:lv(a,r)}}function lv(r,e){return r==="1to10"?1.05:e?.85:.68}const cv=.85;function yA({data:r,heightField:e,boundaries:t,scene:n,quality:i,worldX:s,worldZ:o,footprintHeightAt:a}){const l=r.lights,c=l.x.length,u=new Float32Array(c*3),h=new Float32Array(c),f=new Float32Array(c),d=er==="tiles"&&l.base_height?.length===c?l.base_height:null;er==="tiles"&&!d&&console.warn("Baked soul heights are unavailable or incomplete; using guarded ground-level heights.");const p=TA(l,.5,.5),g=new U;for(let E=0;E<c;E+=1)u[E*3]=s(l.x[E]),u[E*3+1]=0,u[E*3+2]=o(l.y[E]),h[E]=er==="legacy"?a(l.x[E],l.y[E],e):d?.[E]??0,E===p&&(f[E]=1);MA(g,p,u,h,l);const _=new pi;_.setAttribute("position",new Qt(u,3)),_.setAttribute("aBaseHeight",new Qt(h,1)),_.setAttribute("aTStart",hc(l.t_start)),_.setAttribute("aRiseDuration",hc(l.rise_duration)),_.setAttribute("aPeakHeight",hc(l.peak_height)),_.setAttribute("aPeakIntensity",hc(l.peak_intensity)),_.setAttribute("aFocus",new Qt(f,1)),_.setAttribute("aWalker",new Qt(new Float32Array(c),1)),_.setAttribute("aAura",new Qt(new Uint8Array(c*4),4,!0));const m=SA(l,c,p,i.unit);_.setAttribute("aPostwar",new Qt(m.postwar,1)),_.setAttribute("aFadeOrder",new Qt(m.fadeOrder,1));const S=new ki({uniforms:{uRise:{value:0},uScheduleDuration:{value:r.params.duration},uBuildings:{value:0},uPointSize:{value:i.pointSize},uPixelRatio:{value:i.pixelRatio},uOpacity:{value:1},uPopulationFade:{value:0},uIsolate:{value:0},uColor:{value:new et("#fff0d3")},uCloseness:{value:0},uAuraTint:{value:new pt(0,0,0,0)},uWalkerFade:{value:0}},vertexShader:`
      uniform float uRise;
    ...
    `,fragmentShader:`
      ...
      void main() {
        ...
        // Souls inside the lit neighborhood warm to amber and brighten slightly — the
        // aura speaks through the lights themselves; the boundary stays mask-soft.
        vec3 tinted = mix(uColor, vec3(1.0, 0.76, 0.42), vAura * ${i.low?"0.95":"0.85"}) * (1.0 + ${i.low?"0.55":"0.3"} * vAura);
        vec3 focusColor = mix(tinted, vec3(1.0, 0.78, 0.45), vFocus);
        gl_FragColor = vec4(focusColor * (0.75 + core * 0.42), alpha);
      }
    `,transparent:!0,depthWrite:!1,depthTest:!1,blending:Ps,toneMapped:!1}),y=new fy(_,S);y.frustumCulled=!1,y.renderOrder=6,n.add(y);const x=new od({map:zf(),color:"#ffd18a",transparent:!0,opacity:0,depthWrite:!1,depthTest:!1,blending:Ps,toneMapped:!1}),A=new v_(x);return A.position.copy(g),A.scale.setScalar(1.5),A.renderOrder=7,n.add(A),{soulPoints:y,focusGlow:A}}function MA(r,e,t,n,i){r.set(t[e*3],n[e]+i.peak_height[e]*cv,t[e*3+2])}function SA(r,e,t,n){const s=Math.min(e,Math.max(1,Math.round(15e3/(n==="1to10"?10:1)))),o=32,a=new Float32Array(o*o),l=m=>{const S=Math.min(o-1,Math.max(0,Math.floor(r.x[m]*o))),y=Math.min(o-1,Math.max(0,Math.floor(r.y[m]*o)));return S+y*o};for(let m=0;m<e;m+=1)a[l(m)]+=1;const c=new Float32Array(e);for(let m=0;m<e;m+=1)c[m]=a[l(m)];const u=new Float64Array(e);for(let m=0;m<e;m+=1)u[m]=rA(m)/4294967295*c[m];const f=Float64Array.from(u).sort()[mt.clamp(s-1,0,e-1)],d=new Float32Array(e);for(let m=0;m<e;m+=1)d[m]=u[m]<=f?1:0;if(!d[t]){let m=-1;for(let S=0;S<e;S+=1)d[S]&&S!==t&&(m<0||u[S]>u[m])&&(m=S);m>=0&&(d[m]=0),d[t]=1}const p=[];for(let m=0;m<e;m+=1)d[m]||p.push(m);p.sort((m,S)=>u[S]-u[m]);const g=new Float32Array(e),_=p.length;for(let m=0;m<_;m+=1)g[p[m]]=_>1?m/(_-1):0;return{postwar:d,fadeOrder:g}}function TA(r,e,t){let n=0,i=1/0;for(let s=0;s<r.x.length;s+=1){const o=(r.x[s]-e)**2+(r.y[s]-t)**2;o<i&&(n=s,i=o)}return n}function zf(){const r=document.createElement("canvas");r.width=64,r.height=64;const e=r.getContext("2d"),t=e.createRadialGradient(32,32,0,32,32,32);t.addColorStop(0,"rgba(255,255,255,1)"),t.addColorStop(.12,"rgba(255,226,174,0.92)"),t.addColorStop(.42,"rgba(255,190,100,0.26)"),t.addColorStop(1,"rgba(255,175,70,0)"),e.fillStyle=t,e.fillRect(0,0,64,64);const n=new su(r);return n.colorSpace=Mn,n}let Yi=null;function bA({scene:r,geojson:e,boundaries:t,normalizeGeoPoint:n,makeGlowTexture:i}){if(!e?.features?.length||!t?.features?.length)return null;const o=e.features.find(g=>g.geometry?.type==="Polygon")?.geometry?.coordinates?.[0];if(!o?.length)return null;const a=yo(t),l=o.map(g=>{const _=n(g,a);return new U(_.x,.16,_.z)});if(l.length>2&&l[0].distanceToSquared(l.at(-1))<1e-10&&l.pop(),l.length<3)return null;const c=[...l,l[0].clone()],u=[0];for(let g=1;g<c.length;g+=1)u.push(u.at(-1)+c[g-1].distanceTo(c[g]));Yi={points:c,lengths:u,total:u.at(-1)};const h=(g,_)=>new ki({uniforms:{uColor:{value:new et(g)},uProgress:{value:0},uOpacity:{value:_}},vertexShader:`
