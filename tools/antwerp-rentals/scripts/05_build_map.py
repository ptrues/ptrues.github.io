...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  /* The three criteria are the whole brief, so they get to be a proper list. */
  #criteria { margin: clamp(6px, 1.1vh, 9px) 0 0; padding-left: 19px; }
  #criteria li {
    padding-left: 2px; color: var(--ash);
    font-size: 14px; line-height: 1.5;
  }
  #criteria li::marker { color: var(--ash-2); }
...
<aside id="rail">
  ...
  <p id="story">Our landlord is ignoring our request to fix the oven, so I built
